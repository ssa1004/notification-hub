...
| 단계 | 책임 | 회수 | wait |
|---|---|---|---|
| Resilience4j (adapter-out) | 한 vendor 호출 *내부* 의 단발성 5xx/IO 흡수 | 3회 | 200ms → 400ms → 800ms (exp 2.0) ± 50% jitter |
