 ...
 * vendor 별 예외) 는 {@link DeliveryGateway#dispatch} 에서 throw 한다.
 *
 * <p>이 마커가 붙은 예외는 retry 무의미 (invalid token, malformed payload 등) — Resilience4j
 ...
 */
public interface PermanentDeliveryFailure {}
