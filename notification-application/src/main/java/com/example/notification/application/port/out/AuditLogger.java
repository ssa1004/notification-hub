 ...
 *
 * <p>compliance / 사용자 문의 대응 (왜 안 왔는지 / 두 번 왔는지) 에 필수. ADR-0023 결정 톤
...
public interface AuditLogger {
     ...
     * @param action e.g. {@code "NOTIFICATION_ACCEPTED"}, {@code "DELIVERY_DISPATCHED"}
     * @param data 추가 컨텍스트 (PII 는 마스킹된 채로)
     */
    void log(String actor, String action, Map<String, ?> data);
}
